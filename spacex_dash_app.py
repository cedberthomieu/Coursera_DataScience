...
spacex_df = pd.read_csv("C:/DEV/jupyterlab_project/tutorial_project/Coursera/SpaceY/spacex_launch_dash.csv")
...
def scatter(entered_site,payload):
    payload_from = payload[0]
    payload_to = payload[1]
    print(f'Callback input - site: {entered_site}, from {payload_from}, to {payload_to}')
    filtered_df = spacex_df[spacex_df['Payload Mass (kg)'].between(payload_from, payload_to)]
